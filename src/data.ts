...
export const Career: any = Object.freeze({
    reckless: {
        icon: 'game.webp',
        startMonth: 12,
        startYear: 2025,
...
export const Skill: any = Object.freeze({
    game: {
        id: 'skills-game',
        experience: 4,
    },
...
//Properties
export const Category: any = Object.freeze({
    all: 'all',
    games: 'games',
    apps: 'apps',
    design: 'design',
...
export const Tag: any = Object.freeze({
    //All
    all: 'all',
...
export const Sort: any = Object.freeze({
    favs: 'favs',
    date: 'date'
})

export const Scope: any = Object.freeze({
    team: 'team',
    solo: 'solo',
    personal: 'personal',
    jam: 'jam'
...
export const FavPoints: any = Object.freeze({
    top: 125,
    cool: 100,
    fine: 75,
    mid: 50,
...
export const SelectedProjects: any = Object.freeze([
    Project.demo_reel,
    Project.spyw4re,
    Project.tochimochi,
...
export const Achievement: any = Object.freeze({
    theme: 'theme',
    artyom: 'artyom',
    project: 'project',
    contact: 'contact',
